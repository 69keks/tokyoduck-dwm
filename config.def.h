...
/* Adding XF86 functionality to DWM */
...
static const char spaceduck[]       = "#0f111b";
...
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray3, spaceduck, col_gray2 },
	[SchemeSel]  = { spaceduck, col_cyan,  col_cyan  },
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", spaceduck, NULL };
